...
function ecommerce_lite_homepage_products_tabs(){
    if(!ecommerce_lite_is_woocommerce_activated()): return; endif;
    
    //products-tab Customizer Values
    $product_tab_slider_enable = get_theme_mod( 'product_tab_slider_enable',false );
    $products_tabs_title = get_theme_mod( 'products_tabs_title','POPULOR PRODUCTS' );
    $products_tab_multiple_category = get_theme_mod( 'products_tabs_multiple_cat',array(ecommerce_lite_get_default_products_categories()) );
            ...
            <div class="row products-tab-wraper">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="product-tab-list clearfix">
                        <h6 id="products_tabs_title"  class="  text-uppercase"><?php echo esc_html( $products_tabs_title ); ?></h6>
                        ...
                        <ul class="tabs ecommerce-shop-products-tab clearfix">
                                <?php
                                    ...
                                    <li select_category_id = "<?php echo esc_attr( $products_id ); ?>" tab_slider_enable="<?php echo esc_attr( $product_tab_slider_enable ); ?>" tab_product_count = "<?php echo esc_attr( $products_tab_number_of_products ); ?>" class="ecommerce-shop-products-tabs-title tab-link  <?php if( $category_count == 1){ echo 'current'; }$category_count++; ?>"  data-tab="<?php echo esc_attr( $products_id ); ?>"><a href="#<?php echo esc_attr( $term->slug ); ?>"><?php echo esc_attr( $term->name ); ?></a></li>
                ...
                <?php if( $products_tab_multiple_category ): ?>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 products-tab-section">
                        ...
                        <div id="tab-bag" class="tab-content current">
                            <div class="<?php if( $product_tab_slider_enable != false ){ echo esc_attr("owl-carousel");  } ?>  product-tab">
                                ...
                                ?>
                                            ...
                                            <?php  if( $products_count > 0 and  $products_count % 4 == 0 and $product_tab_slider_enable != false ) : echo '</div></div> <div class="item"> <div class="row">'; endif ; ?>
...
add_action( 'products_tab','ecommerce_lite_homepage_products_tabs');
...
function ecommerce_lite_customizer_section(){
	...
	if( ecommerce_lite_is_woocommerce_activated() ){
		$ecommerce_lite_woocommerce_section_array = array('ecommerce_lite_homepage_products_category','ecommerce_lite_homepage_service_section', 'ecommerce_lite_homepage_banner_sections','ecommerce_lite_homepage_products_tabs');
	}else{

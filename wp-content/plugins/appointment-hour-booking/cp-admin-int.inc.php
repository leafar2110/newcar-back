...
<div class="wrap">
<h1><?php _e('Edit','cpappb'); ?> - <?php echo $this->get_option('form_name','Calendar'); ?></h1>
...
<div id="topadminsection"  class="ahb-buttons-container">
	...
	<a href="<?php print esc_attr(admin_url('admin.php?page='.$this->menu_parameter));?>" class="ahb-return-link">&larr;<?php _e('Return to the calendars list','cpappb'); ?></a>
	<div class="clear"></div>
</div>
...
<div class="ahb-adintsection-container">
	<div class="ahb-breadcrumb">
		<div class="ahb-step ahb-step-active" data-step="1">
			<i>1</i>
			<label><?php _e('Editor','cpappb'); ?></label>
		</div>
		<div class="ahb-step" data-step="2">
			<i>2</i>
			<label><?php _e('General Settings','cpappb'); ?></label>
		</div>
		<div class="ahb-step" data-step="3">
			<i>3</i>
			<label><?php _e('Notification Emails','cpappb'); ?></label>
		</div>
        ...
        <div class="ahb-step" data-step="6">
			<i>6</i>
			<label><?php _e('Add Ons','cpappb'); ?></label>
		</div>
	</div>
    ...
    <div class="ahb-adintsection ahb-adintsection-active" data-step="1">
       <div class="inside">
         ...
         <div style="background:#fafafa;min-width:600px" class="form-builder">
             ...
             <div class="column width50">
                 <div id="tabs">
         			<ul>
         				<li><a href="#tabs-1"><?php _e('Add a Field','cpappb'); ?></a></li>
         				<li><a href="#tabs-2"><?php _e('Field Settings','cpappb'); ?></a></li>
         				<li><a href="#tabs-3"><?php _e('Form Settings','cpappb'); ?></a></li>
         			</ul>
         			<div id="tabs-1">
      ...
      <!-- TEXT DEFINITIONS -->
	  <h2><?php _e('Labels and Texts','cpappb'); ?></h2>
	  <hr />

      <h3 class='hndle' style="padding:5px;"><span><?php _e('Button Labels','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <td scope="row">
             <strong><?php _e('Submit button label (text)','cpappb'); ?>:</strong><br />
            ...
            <td>
              <strong><?php _e('Page {0} of {0} (text','cpappb'); ?>):</strong><br />
            ...
            <tr valign="top">
            <td scope="row">
             <strong><?php _e('Previous page button label (text)','cpappb'); ?>:</strong><br />
            ...
            <td scope="row">
             <strong><?php _e('Next page button label (text)','cpappb'); ?>:</strong><br />
      ...
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Error messages for validation rules','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <td scope="row">
             <strong><?php _e('"is required" text','cpappb'); ?>:</strong><br />
            ...
            <td scope="row">
             <strong><?php _e('"is email" text','cpappb'); ?>:</strong><br />
            ...
            <tr valign="top">
            <td scope="row">
             <strong><?php _e('"is valid captcha" text','cpappb'); ?>:</strong><br />
            ...
            <td scope="row"><strong><?php _e('"is valid date (mm/dd/yyyy)" text','cpappb'); ?>:</strong><br /><input type="text" name="vs_text_datemmddyyyy" size="40" value="<?php echo esc_attr($this->get_option('vs_text_datemmddyyyy', CP_APPBOOK_DEFAULT_vs_text_datemmddyyyy)); ?>" /></td>
            </tr>
            <tr valign="top">
            <td scope="row">
             <strong><?php _e('"is valid date (dd/mm/yyyy)" text','cpappb'); ?>:</strong><br />
            ...
            <td scope="row">
             <strong><?php _e('"is number" text','cpappb'); ?>:</strong><br />
            ...
            <tr valign="top">
            <td scope="row">
             <strong><?php _e('"only digits" text','cpappb'); ?>:</strong><br />
            ...
            <td scope="row">
             <strong><?php _e('"under maximum" text','cpappb'); ?>:</strong><br />
            ...
            <tr valign="top">
            <td scope="row">
             <strong><?php _e('"over minimum" text','cpappb'); ?>:</strong><br />
            ...
            <td scope="row">
             <strong><?php _e('"Max appointments allowed messsage" text','cpappb'); ?>:</strong><br />
		...
		<div class="ahb-buttons-container">
			<input type="button" value="<?php _e('Next Step - General Settings >','cpappb'); ?>" class="button" style="float:right;margin-right:10px" onclick="ahbGoToStep(2);" />
			<input type="submit" name="savepublish" value="<?php _e('Save and Publish','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<input type="submit" name="savereturn" value="<?php _e('Save and Return','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<div class="clear"></div>
		</div>
     </div>
     ...
     <div class="ahb-adintsection" data-step="2">
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Global Calendar Settings','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Date Format','cpappb'); ?></th>
            <td><?php $v = $this->get_option('date_format','mm/dd/yy'); ?>
         	   <select name="date_format">
    		   <option <?php if ($v == '' || $v == 'mm/dd/yy') echo 'selected'; ?> value="mm/dd/yy">Default - mm/dd/yy</option>
               <option <?php if ($v == 'dd/mm/yy') echo 'selected'; ?> value="dd/mm/yy">dd/mm/yy</option>
               <option <?php if ($v == 'mm.dd.yy') echo 'selected'; ?> value="mm.dd.yy">mm.dd.yy</option>
               <option <?php if ($v == 'dd.mm.yy') echo 'selected'; ?> value="dd.mm.yy">dd.mm.yy</option>
    		   <option <?php if ($v == 'yy-mm-dd') echo 'selected'; ?> value="yy-mm-dd">ISO 8601 - yy-mm-dd</option>
    		   <option <?php if ($v == 'd M, y') echo 'selected'; ?> value="d M, y">Short - d M, y</option>
    		   <option <?php if ($v == 'd MM, y') echo 'selected'; ?> value="d MM, y">Medium - d MM, y</option>
    		   <option <?php if ($v == 'DD, d MM, yy') echo 'selected'; ?> value="DD, d MM, yy">Full - DD, d MM, yy</option>
        	   </select>
            </td>
            </tr>
            <tr valign="top">
            <th scope="row"><?php _e('Calendar Language','cpappb'); ?></th>
    ...
    <option <?php if ($v == 'cy_GB') echo 'selected'; ?> value="cy_GB">Welsh/UK</option>
      ...
      <hr />
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Payment Integration Settings','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Product name at payment page','cpappb'); ?></th>
            <td><input type="text" name="product_name" size="40" value="<?php echo esc_attr($this->get_option('product_name', 'Booking')); ?>" /></td>
            </tr>
            <tr valign="top">
            <th scope="row"><?php _e('Label of "Pay Later" option (if enabled)','cpappb'); ?></th>
            <td><input type="text" name="pay_later_label" size="40" value="<?php echo esc_attr($this->get_option('pay_later_label', 'Pay later')); ?>" /></td>
            </tr>
         </table>
         <em>* <?php _e('Note: To enable a payment method enable first the related addon.','cpappb'); ?></em>
      </div>
      <hr />
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Users with access to the messages lis','cpappb'); ?>t</span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Select users with access (CTRL+click for multiple selection)','cpappb'); ?>:</th>
            <td>
              <?php
      ...
      <hr>
		<div class="ahb-buttons-container">
			<input type="button" value="<?php _e('Next Step - Notification Emails >','cpappb'); ?>" class="button" style="float:right;margin-right:10px" onclick="ahbGoToStep(3);" />
			<input type="submit" name="savepublish" value="<?php _e('Save and Publish','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<input type="submit" name="savereturn" value="<?php _e('Save and Return','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<div class="clear"></div>
		</div>
     ...
     <div class="ahb-adintsection" data-step="3">
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Form Processing','cpappb'); ?> / <?php _e('Email Settings','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            ...
            <td>
              <?php $option = $this->get_option('fp_emailfrommethod', "fixed"); ?>
               <select name="fp_emailfrommethod">
                 <option value="fixed"<?php if ($option == 'fixed') echo ' selected'; ?>><?php _e('From fixed email address indicated below - Recommended option','cpappb'); ?></option>
                 <option value="customer"<?php if ($option == 'customer') echo ' selected'; ?>><?php _e('From the email address indicated by the custome','cpappb'); ?>r</option>
                </select><br />
            ...
            <tr valign="top">
            <th scope="row"><?php _e('"From" email (for fixed "from" addresses)','cpappb'); ?></th>
            ...
            <th scope="row"><?php _e('Send email "To"','cpappb'); ?> </th>
            <td>
              <?php $option = $this->get_option('fp_emailtomethod', "fixed"); ?>
               <select name="fp_emailtomethod" onchange="update_cpappb_option();">
                 <option value="fixed"<?php if ($option == 'fixed') echo ' selected'; ?>><?php _e('To the fixed email(s) address(es) indicated below - Recommended option','cpappb'); ?></option>
                 <option value="customer"<?php if ($option == 'customer') echo ' selected'; ?>><?php _e('To the email address selected in a form field (ex: captcha image enabled is recommended in this case)','cpappb'); ?></option>
                </select><br />
                <span style="font-size:10px;color:#666666">
                * <?php _e('If you select "To fixed..." enter the destination emails in the next field. ','cpappb'); ?>
                <br />
                * <?php _e('If you select "To email ...in form field" then add a field like a drop-down, radio-button or checkbox that contains the email address in the field value (not needed in the field text but in the internal value).','cpappb'); ?>
                </span>
            </td>
            </tr>
            <tr valign="top" id="cpappb_destemails" <?php if ($option == 'customer') echo ' style="display:none;"'; ?>>
            <th scope="row"><?php _e('Destination emails (comma separated)','cpappb'); ?></th>
            ...
            <th scope="row"><?php _e('Field that cotains the destination email(s)','cpappb'); ?></th>
            <td>
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Include additional information?','cpappb'); ?></th>
            <td>
              ...
              <select name="fp_inc_additional_info">
               <option value="true"<?php if ($option == 'true') echo ' selected'; ?>><?php _e('Yes','cpappb'); ?></option>
               <option value="false"<?php if ($option == 'false') echo ' selected'; ?>><?php _e('No','cpappb'); ?></option>
              </select>
            </td>
            </tr>
            <tr valign="top">
            <th scope="row"><?php _e('Thank you page (after sending the message','cpappb'); ?>)</th>
            <td><input type="text" name="fp_return_page" size="70" value="<?php echo esc_attr($this->get_option('fp_return_page', CP_APPBOOK_DEFAULT_fp_return_page)); ?>" /></td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Message','cpappb'); ?></th>
      ...
      <hr />
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Email Copy to User','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Send confirmation/thank you message to user?','cpappb'); ?></th>
            <td>
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Email field on the form','cpappb'); ?></th>
		...
		<hr>
		<div class="ahb-buttons-container">
			<input type="button" value="<?php _e('Next Step - Antispam >','cpappb'); ?>" class="button" style="float:right;margin-right:10px" onclick="ahbGoToStep(4);" />
			<input type="submit" name="savepublish" value="<?php _e('Save and Publish','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<input type="submit" name="savereturn" value="<?php _e('Save and Return','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<div class="clear"></div>
		</div>
     ...
     <div class="ahb-adintsection" data-step="4">
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Captcha Verification','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Use Captcha Verification?','cpappb'); ?></th>
            <td colspan="5">
            ...
            <tr valign="top">
             <th scope="row"><?php _e('Width','cpappb'); ?>:</th>
             ...
             <th scope="row"><?php _e('Height','cpappb'); ?>:</th>
             ...
             <th scope="row"><?php _e('Chars','cpappb'); ?>:</th>
            ...
            <tr valign="top">
             <th scope="row" valign="top"><?php _e('Min font size','cpappb'); ?>:</th>
             ...
             <th scope="row" valign="top"><?php _e('Max font size','cpappb'); ?>:</th>
            ...
            <tr valign="top">
             <th scope="row"><?php _e('Noise','cpappb'); ?>:</th>
             ...
             <th scope="row"><?php _e('Noise Length','cpappb'); ?>:</th>
            ...
            <tr valign="top">
             <th scope="row"><?php _e('Background','cpappb'); ?>:</th>
             ...
             <th scope="row"><?php _e('Border','cpappb'); ?>:</th>
             ...
             <th scope="row"><?php _e('Font','cpappb'); ?>:</th>
             <td>
		...
		<hr>
		<div class="ahb-buttons-container">
			<input type="button" value="<?php _e('Next Step - Reports >','cpappb'); ?>" class="button" style="float:right;margin-right:10px" onclick="ahbGoToStep(5);" />
			<input type="submit" name="savepublish" value="<?php _e('Save and Publish','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<input type="submit" name="savereturn" value="<?php _e('Save and Return','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<div class="clear"></div>
		</div>
     ...
     <div class="ahb-adintsection" data-step="5">
      <h3 class='hndle' style="padding:5px;"><span><?php _e('Automatic Reports: Send submissions in CSV format via email','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Enable Reports?','cpappb'); ?></th>
            <td>
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Send report every','cpappb'); ?></th>
            <td><input type="text" name="rep_days" size="4" value="<?php echo esc_attr($this->get_option('rep_days', '1')); ?>" /> <?php _e('days (Put a 0 to send the report immediately after each submission)','cpappb'); ?></td>
            </tr>
            <tr valign="top">
            <th scope="row"><?php _e('Send report after this hour (server time)','cpappb'); ?></th>
            <td>
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Send the report to the following email addresses (comma separated)','cpappb'); ?></th>
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Email Text (CSV file will be attached with the submissions)','cpappb'); ?></th>
        ...
        <hr>
		<div class="ahb-buttons-container">
			<input type="button" value="<?php _e('Next Step - Add Ons >','cpappb'); ?>" class="button" style="float:right;margin-right:10px" onclick="ahbGoToStep(6);" />
			<input type="submit" name="savepublish" value="<?php _e('Save and Publish','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<input type="submit" name="savereturn" value="<?php _e('Save and Return','cpappb'); ?>" class="button button-primary" style="float:right;margin-right:10px" />
			<div class="clear"></div>
		</div>
    ...
    <div class="ahb-adintsection" data-step="6">
     <?php
    	...
    	{
    		_e( '<h2>Add-Ons Settings:</h2><hr />', 'cpappb' );
        ...
        {
            ?>
            <p>You can optionally <a target="_blank" href="?page=cp_apphourbooking_addons">activate add ons in the add ons section</a>.</p>

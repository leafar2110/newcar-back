			...
			showSpecialDataInstance: function() 
				{
					...
					str += '<div><input type="checkbox"  name="sBSlotsCheckbox" id="sBSlotsCheckbox" '+((this.bSlotsCheckbox)?"checked":"")+'/> Generate time slots automatically based on service duration<div id="sBSlotsDiv" style="display:'+((this.bSlotsCheckbox)?"none":"block")+'">Generate slots every <select class="BSlots" name="sBSlots" id="sBSlots">';
					for (var j=1;j<=24*12;j++)

...
?>
   <tr>
    ...
    <td>
<?php if ($current_user_access) { ?>
                             <input style="margin-bottom:5px;" class="button" type="button" name="calupdate_<?php echo $item->id; ?>" value="<?php _e('Rename','cpappb'); ?>" onclick="cp_updateItem(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button-primary button" type="button" name="calmanage_<?php echo $item->id; ?>" value="<?php _e('Edit','cpappb'); ?>" onclick="cp_manageSettings(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button-primary button" type="button" name="calpublish_<?php echo $item->id; ?>" value="<?php _e('Publish','cpappb'); ?>" onclick="cp_publish(<?php echo $item->id; ?>);" />
<?php } ?>
                             <input style="margin-bottom:5px;" class="button" type="button" name="calmessages_<?php echo $item->id; ?>" value="<?php _e('Booking Orders','cpappb'); ?>" onclick="cp_viewMessages(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button" type="button" name="calschedule_<?php echo $item->id; ?>" value="<?php _e('Schedule','cpappb'); ?>" onclick="cp_viewSchedule(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button" type="button" name="caladdbk_<?php echo $item->id; ?>" value="<?php _e('Add Booking','cpappb'); ?>" onclick="cp_addbk(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button" type="button" name="calreport_<?php echo $item->id; ?>" value="<?php _e('Stats','cpappb'); ?>" onclick="cp_viewReport(<?php echo $item->id; ?>);" />
<?php if ($current_user_access) { ?>
                             <input style="margin-bottom:5px;" class="button" type="button" name="calclone_<?php echo $item->id; ?>" value="<?php _e('Clone','cpappb'); ?>" onclick="cp_cloneItem(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button" type="button" name="caldelete_<?php echo $item->id; ?>" value="<?php _e('Delete','cpappb'); ?>" onclick="cp_deleteItem(<?php echo $item->id; ?>);" />
<?php } ?>
    </td>

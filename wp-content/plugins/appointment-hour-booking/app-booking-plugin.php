...
define('CP_APPBOOK_DEFAULT_fp_subject', 'Contact from the blog...');
...
define('CP_APPBOOK_DEFAULT_cu_user_email_field', '');
define('CP_APPBOOK_DEFAULT_cu_subject', 'Confirmation: Message received...');
...
function cpappb_plugin_init() {
   load_plugin_textdomain( 'cpappb', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );

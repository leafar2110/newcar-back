...
(function($) {
	...
	$(document).ready( function() {
			...
			$selector.each( function() {
				...
				$(this).find( '.addon, .wc-pao-addon-field' ).each( function() {
					...
					if ( $this.is('.addon-custom-price, .wc-pao-addon-custom-price') ) {
						addon_cost = $this.val();
					} else if ( $this.is('.addon-input_multiplier, .wc-pao-addon-input_multiplier') ) {
					...
					} else if ( $this.is('.addon-select, .wc-pao-addon-select') ) {
						if ( $this.val() )
		...
		* WooCommerce Product Add-ons compatibility
		*/
		$('.product-addon input, .product-addon textarea, .product-addon select, .product-addon input.qty, .wc-pao-addon input, .wc-pao-addon textarea, .wc-pao-addon select, .wc-pao-addon input.qty').on( 'woocommerce-product-addons-update', function() {
